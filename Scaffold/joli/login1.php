...
?>
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <!-- START PAGE SIDEBAR -->
            <div class="page-sidebar" style="ackground-color : white;">
                <!-- START X-NAVIGATION -->
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap" style="padding-top : 35px; padding-top : 40px;">
                            ...
                            <div class="">
                                ...
                                <div class="col">
                                    ...
                                    <div class="widget widget-default widget-item-icon" >
                                        ...
                                        <div class="widget-data">
                                            <div class="widget-int num-count"><?php echo $getmessagerow['messages']; ?></div>
