...
<head>
    ...
    <?php
                    ...
                    $query1="SELECT count(*) from saving_dept ";
                    $query2="SELECT count(*) from fixed_dept ";
                    $query3="SELECT count(*) from current_dept ";
                    $query4="SELECT count(*) from recurring_dept ";
                    $query5="SELECT count(*) from user ";
                    $query6="SELECT sum(balance) from saving_dept ";
                    $query7="SELECT sum(balance) from fixed_dept ";
                    $query8="SELECT sum(balance) from current_dept ";
                    $query9="SELECT sum(balance) from recurring_dept ";
                    $query23="SELECT * FROM chartData order by timeu desc";
                    $query24="SELECT * FROM chartData1 order by timeu desc"; 
                    $query21="SELECT sum(balance) from allAcc ";
                    ...
                    $result4=mysqli_query($db,$query3) or die("account no couldnt be found!!");
                    $result5=mysqli_query($db,$query5) or die("login couldnt be completed!!");
                    $result6=mysqli_query($db,$query6) or die("account no couldnt be found!!");
                    $result7=mysqli_query($db,$query7) or die("account no couldnt be found!!");
                    $result8=mysqli_query($db,$query8) or die("account no couldnt be found!!");
                    $result9=mysqli_query($db,$query9) or die("account no couldnt be found!!");
                    $result23=mysqli_query($db,$query23);
                    $result24=mysqli_query($db,$query24);
                    $result21=mysqli_query($db,$query21) or die("account no couldnt be found!!");
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="widget widget-default widget-carousel">
                            <div class="owl-carousel" id="owl-example">
                                <div>
                                    <div class="widget-title">Savng Deposit</div>
                                    <div class="widget-subtitle">Total users</div>
                                    <div class="widget-int"><?php echo $row1['count(*)']?></div>
                                </div>
                                <div>
                                   	<div class="widget-title">Fixed Deposit</div>
                                    <div class="widget-subtitle">Total users</div>
                                    <div class="widget-int"><?php echo $row2['count(*)']?></div>
                                </div>
                                <div>
                                    <div class="widget-title">Current Deposit</div>
                                    <div class="widget-subtitle">Total user</div>
                                    <div class="widget-int"><?php echo $row3['count(*)']?></div>
                                </div>
                                <div>
                                    <div class="widget-title">Recurring Deposit</div>
                                    <div class="widget-subtitle">Total user</div>
                                    <div class="widget-int"><?php echo $row4['count(*)']?></div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="widget widget-default widget-item-icon" >
                            ...
                            <div class="widget-data">
                                <div class="widget-int num-count"><?php echo $row5['count(*)']?></div>
                                <div class="widget-title">Total Users</div>
                                <div class="widget-subtitle">In miniBank</div>
                            </div>
                            <div class="widget-controls">
                                <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget">
                                    <span class="fa fa-times"></span>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="widget widget-default widget-item-icon" >
                            ...
                            <div class="widget-data">
                                <div class="widget-int num-count" style="font-size:24px;"><?php echo $row21['sum(balance)']?></div>
                                <div class="widget-title">Total Bank Worth</div>
                                <div class="widget-subtitle">of miniBANK</div>
                            </div>
                            <div class="widget-controls">
                                <a href="#" class="widget-control-right widget-remove" data-toggle="tooltip" data-placement="top" title="Remove Widget">
                                    <span class="fa fa-times"></span>
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title-box">
                                    <h3>Bank Worth Statics</h3>
                                    <span>Amount present in miniBANK</span>
                                </div>
                    ...
                    <div class="col-md-8">
                        <?php
                            ...
                            {
                                $chart_data .= "{ date:'".$row23["timeu"]."', deposit:".$row23["deposit"].", withdraw:".$row23["withdraw"].", transfer:".$row23["transfer"]."}, ";
                            ...
                            {
                                $chart_data1 .= "{ date:'".$row24["timeu"]."', deposit:".$row24["deposit"].", withdraw:".$row24["withdraw"].", transfer:".$row24["transfer"]."}, ";
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="panel-title-box">
                                    <h3>Transaction</h3>
                                    <span>transaction statics of previous 10 days</span>
                                </div>
                                <ul class="panel-controls" style="margin-top: 2px;">
                                    <li>
                                        <a href="#" class="panel-fullscreen">
...
<script>
     Morris.Donut({
        ...
        data: [
            {label: "Saving Deposit", value:<?php echo $row6['sum(balance)']?>},
            {label: "Fixed Deposit", value: <?php echo $row7['sum(balance)']?>},
            {label: "Current Deposit", value: <?php echo $row8['sum(balance)']?>},
            {label: "Recurring Deposit", value: <?php echo $row9['sum(balance)']?>}
        ],
        colors: ['#0f0','#f00','#1f61db', '#aaa' ],
        resize: true
    });
    ...
    Morris.Line({
      ...
      xkey: 'date',
      ykeys: ['deposit','withdraw','transfer'],
      labels: ['Deposit','Withdrawed','Transfer'],
      resize: true,
      hideHover: true,
      xLabels: 'day',
      gridTextSize: '10px',
        lineColors: ['#1f61db','#aaa','#0f0'],
