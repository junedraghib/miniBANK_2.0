$(function(){        
    ...
    /* Moris Area Chart */
      ...
      data: [
          { y: '2014-10-10', a: 17, b: 19, c: 16, d: 15},
          { y: '2014-10-11', a: 19, b: 21, c: 23, d: 34},
          { y: '2014-10-12', a: 22, b: 25, c: 36, d: 45},
          { y: '2014-10-13', a: 20, b: 22, c: 46, d: 35},
          { y: '2014-10-14', a: 21, b: 24, c: 56, d: 25},
          { y: '2014-10-15', a: 34, b: 37, c: 41, d: 35},
          { y: '2014-10-16', a: 43, b: 45, c: 26, d: 13}
      ],
      xkey: 'y',
          ykeys: ['a', 'b','c', 'd'],
      labels: ['Sales','Event','test1','test2'],
      resize: true,
      hideHover: true,
      xLabels: 'day',
      gridTextSize: '10px',
          lineColors: ['#1f61db', '#aaa', '#f00', '#0f0'],
